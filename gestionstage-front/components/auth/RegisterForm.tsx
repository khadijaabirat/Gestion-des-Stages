              ...
              {role === 'student' ? (
                ...
                >
                  <div className="grid grid-cols-2 gap-4">
                    <InputField
                      ...
                      onBlur={(v: string) => handleBlur('firstName', v)}
                    ...
                    <InputField
                      ...
                      onBlur={(v: string) => handleBlur('lastName', v)}
                  ...
                  <InputField
                    ...
                    onBlur={(v: string) => handleBlur('email', v)}
                  ...
                  <InputField
                    ...
                    onChange={(v: string) => setFormData({ ...formData, school: v })}
                    onBlur={(v: string) => handleBlur('school', v)}
                ...
                >
                  <InputField
                    ...
                    onBlur={(v: string) => handleBlur('companyName', v)}
                  ...
                  <InputField
                    ...
                    onBlur={(v: string) => handleBlur('website', v)}
                  ...
                  <SelectField
                    ...
                    onChange={(v: string) => { setFormData({ ...formData, sector: v }); handleBlur('sector', v); }}
