...
export default function Features() {
  const features = [
    {
      title: "Match Parfait",
      description: "Notre algorithme intelligent analyse vos compétences (Skills) et les exigences des offres pour des correspondances sur mesure.",
    ...
    {
      title: "Temps Réel",
      description: "Ne manquez aucune opportunité grâce aux notifications push et notre messagerie intégrée fluide.",
    ...
    },
    {
      ...
      description: "Une plateforme de confiance. Chaque profil et offre de stage est rigoureusement vérifié par nos administrateurs.",
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 lg:px-12 mb-32 py-16 relative overflow-hidden" style={{ perspective: "1500px" }}>
      ...
      <div className="text-center mb-20 relative z-10">
        ...
        >
          Des technologies de pointe et une modération stricte pour vous offrir l'expérience de recrutement la plus fluide au monde.
        </motion.p>
      </div>
